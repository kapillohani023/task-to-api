    ...
    <div className="flex min-h-screen items-start justify-center bg-base px-4 py-10">
      <T2ACard padding="lg" className="w-full max-w-2xl">
        ...
        <div className="space-y-6">
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">2. Description of Service</h2>
            <p className="text-base text-fg leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">3. User Accounts</h2>
            <p className="text-base text-fg leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">4. API Keys</h2>
            <p className="text-base text-fg leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">5. Acceptable Use</h2>
            <p className="text-base text-fg leading-relaxed">You agree not to:</p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">6. Intellectual Property</h2>
            <p className="text-base text-fg leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">7. Limitation of Liability</h2>
            <p className="text-base text-fg leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">8. Termination</h2>
            <p className="text-base text-fg leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-fg mb-2">9. Changes to Terms</h2>
            <p className="text-base text-fg leading-relaxed">
